...
- Do NOT list dishes that have no fixed ingredients or recipe, such as daily specials, rotating soups, or items marked "inquire for today's selection", "ask your server", or similar — these cannot be costed.
- DO list market price items that have identifiable ingredients — set their price to null.
- If a dish offers a binary format choice (e.g. "Traditional or Boneless", "grilled or fried"), create TWO separate menu items, one for each format. Name them clearly e.g. "Traditional Wings" and "Boneless Wings".
- Sauce or flavor options listed under a dish are ingredient variants — do not create separate items for each sauce, and do not include all sauces simultaneously in one recipe. Use a generic sauce component instead (e.g. "Wing Sauce").
- The menu may be photographed at any angle or orientation. Read all text regardless of rotation — do not skip sections because they appear sideways or upside down.
