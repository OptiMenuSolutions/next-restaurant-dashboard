        ...
        <div key={i} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, height: '100%' }}>
          <div style={{ flex: 1, width: '100%', display: 'flex', alignItems: 'flex-end' }}>
            <div style={{
              ...
              background: i === data.length - 1 ? '#02a4ba' : `rgba(2,164,186,${0.2 + (i / data.length) * 0.65})`,
              ...
              {i === data.length - 1 && d.value > 0 && (
                <div style={{ position: 'absolute', top: -18, left: '50%', transform: 'translateX(-50%)',
                  fontSize: 8, color: '#02a4ba', fontFamily: "'DM Mono', monospace", whiteSpace: 'nowrap' }}>
...
const s = {
  ...
  search: {
    width: '100%', padding: '7px 12px', fontSize: 11, marginBottom: 12,
  ...
  th: {
    ...
    letterSpacing: '0.8px', padding: '8px 12px', textAlign: 'left',
