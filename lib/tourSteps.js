...
export const PAGE_STEPS = {
  dashboard: [
    ...
    { selector: '[data-tour="db-grid-wrap"]', padding: 6, title: "Every night's pass, printed for you", text: "Tonight's push list \u2014 the exact rail your kitchen checks before service." },
    ...
    { selector: '[data-tour="db-waste"]', padding: 8, title: 'Know what to sell before it spoils', text: "Every ingredient closing in on its shelf life, ranked by urgency \u2014 so nothing gets thrown away quietly." },
    { selector: '[data-tour="db-week"]', padding: 8, title: 'How the last 7 nights actually went', text: 'Extra covers sold, waste saved, and your hit rate \u2014 browse any night on the calendar to see exactly what moved.' },
  ...
  invoices: [
    { selector: '[data-tour="inv-upload"]', padding: 8, title: 'Upload once, read forever', text: 'Drop in a photo or PDF and OptiMenu reads the supplier, the date, and every line item \u2014 no retyping.' },
  ...
  ingredients: [
    ...
    { selector: '[data-tour="ing-row"]', padding: 6, clickTarget: true, title: 'Click an ingredient', text: 'Open any ingredient to see its full price history and purchase trail.' },
    { selector: '[data-tour="ing-detail"]', padding: 8, title: 'Watch costs before they hurt margin', text: 'Price history, purchase records, and every dish this ingredient touches \u2014 right here.' },
  ...
  'menu-items': [
    ...
    { selector: '[data-tour="mi-card"]', padding: 6, clickTarget: true, title: 'Click a dish', text: 'Open any dish to see the full ingredient breakdown behind its margin.' },
    { selector: '[data-tour="mi-detail"]', padding: 8, title: 'This dish, priced down to the ingredient', text: "Every component and ingredient behind this dish's cost, and whether it's performing above or below your margin target." },
  ...
  analytics: [
    { selector: '[data-tour="an-trend"]', padding: 10, title: 'Every night, cost-matched automatically', text: 'This chart tracks what sold against what it truly cost \u2014 synced from your POS every night, no manual entry.' },
...
export function roundedRectHole(x, y, w, h, r) {
