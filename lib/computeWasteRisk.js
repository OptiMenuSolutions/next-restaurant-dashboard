 ...
 *
 * Computes per-delivery waste risk rows for the dashboard.
 *
 ...
 */
function buildDishIngredientMap(menuItems) {
  const map = new Map();
...
/**
 * Computes waste risk rows for all active ingredient deliveries.
 *
 ...
 */
export function computeWasteRisk(invoiceItems, invoices, posSales, menuItems) {
